        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgLink = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Transactions_AddressId_DateTime_CardType_EntryMode_Bank", x => new { x.AddressId, x.DateTime, x.CardType, x.EntryMode, x.Bank });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Ratings_CustomerId_ProductId", x => new { x.CustomerId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Orders_CustomerId_TransactionId_AddressId_DateTime_Type", x => new { x.CustomerId, x.TransactionId, x.AddressId, x.DateTime, x.Type });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_LineItems_OrderId_ProductId", x => new { x.OrderId, x.ProductId });
                    table.ForeignKey(
